...
class Meta_Box_Import
{
	...
	{
		if ( isset( $_GET['post_type'] ) && $_GET['post_type'] === 'meta-box-builder' ) :
			?>
			<script type="text/javascript">
				jQuery( document ).ready( function ( $ )
				{
					$( '<option>' ).val( 'export' ).text( 'Export' )
	 ...
	 * @todo Set translation string
	 */
	public static function page()
	{
		?>
		<div class="wrap">
			<h2>Import Meta Boxes</h2>
	...
	public static function handle_post()
	{
		...
		if ( isset( $_REQUEST['action2'] ) && $_REQUEST['action2'] === 'export' && ! empty( $_REQUEST['post'] ) )
		{
			$posts = $_REQUEST['post'];
