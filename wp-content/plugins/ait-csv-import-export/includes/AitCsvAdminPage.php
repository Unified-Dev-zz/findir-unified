...
class AitCsvAdminPage
{
	...
	public function adminPage(){
		...
		echo '<div class="wrap">';
			echo '<div id="'.$this->codeName.'-page" class="ait-admin-page">';
						...
						echo '<div class="ait-options-page-content">';
							echo '<div class="ait-options-sidebar">';
								echo '<div class="ait-options-sidebar-content">';
									echo '<h3 class="ait-options-sidebar-title">'.$this->optionTitle.'</h3>';
							...
							echo '<div class="ait-options-content">';
								echo '<div class="ait-options-content-header">';
									echo '<h1><span id="ait-options-panel-title">'.$this->optionTitle.'</span></h1>';
								echo '</div>';
			...
			<div class='ait-opt-container ait-opt-select-main'>
				<div class='ait-opt-wrap'>
					...
					<div class="ait-backup-action">
		            	<input type="submit" value="<?php _e('Export CSV', 'ait-csv-import-export'); ?>" class="ait-button button button-primary">
					</div>
			</div>
			</div>
